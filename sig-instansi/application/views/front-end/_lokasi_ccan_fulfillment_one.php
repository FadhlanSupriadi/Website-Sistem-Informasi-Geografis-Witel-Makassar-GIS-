            ...
            <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDj-hFGBMNwgXz91WdQn5O1N6mgxKJcX1U&callback=initMap"></script>
                  ...
                  <script>
                    ...
                    <?php
                      ...
                      $as = $this->db->query("SELECT l.id, l.sid, l.no_order, l.nama_odp, l.port, l.sn_ont, l.alamat, l.keterangan, l.latittude, l.longitude, k.nama_kategori, k.ikon FROM lokasi_ccan_fulfillment as l, kategori as k WHERE l.kategori=k.id AND l.id = $id");
