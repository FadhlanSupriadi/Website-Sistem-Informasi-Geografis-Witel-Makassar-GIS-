            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Lokasi CCAN Assurance</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?=form_open('dashboard/lokasi_ccan_assurance') ?>
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_node" type="text" class="form-control" placeholder="Nama Node" required="">
                        </div>
                        <div class="form-group">
                            <label>Port</label>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?=base_url().'dashboard/lokasi_ccan_assurance' ?>" class="btn btn-warning btn-flat"><i class="fa fa-retweet"></i> Kembali</a>
                    </div>
                    </form>
                </div>
                <!-- /.box -->
