            ...
            <div class="col-sm-5">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Kategori CCAN Fulfillment</h3>
                </div>
                <!-- /.box-header -->
                ...
                <a href="<?=base_url().'dashboard/lokasi_ccan_fulfillment_kategori' ?>" class="btn btn-warning btn-flat"><i class="fa fa-retweet"></i> Kembali</a>
                </div>
              </div>
              </form>
              <!-- /.box -->
