            ...
            <div class="col-sm-5">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Kategori CCAN Assurance</h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?=base_url().'dashboard/lokasi_ccan_assurance_kategori' ?>" class="btn btn-warning btn-flat"><i class="fa fa-retweet"></i> Kembali</a>
                    </div>
                </div>
                </form>
                <!-- /.box -->
