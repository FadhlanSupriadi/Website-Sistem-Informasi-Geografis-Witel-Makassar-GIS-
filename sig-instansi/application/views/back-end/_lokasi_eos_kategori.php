    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Kategori EOS</h3>
                    </div>
                    <!-- /.box-header -->
                    <?=form_open_multipart('dashboard/lokasi_eos_kategori') ?>
                    <div class="box-body">
            ...
            <div class="col-md-7">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Daftar Kategori EOS</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php $no=1; foreach($k->result() as $r){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-success btn-sm btn-flat" href="<?=base_url().'dashboard/lokasi_eos_kategori_edit/'.$r->id ?>"><i class="fa fa-edit"></i> </a>
                                            <a class="btn btn-danger btn-sm btn-flat" href="<?=base_url().'dashboard/lokasi_eos_kategori_delete/'.$r->id ?>"><i class="fa fa-trash"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
